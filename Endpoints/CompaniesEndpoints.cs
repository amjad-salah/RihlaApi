...
public static class CompaniesEndpoints
{
    public static void MapCompaniesEndpoints(this WebApplication app)
    {
        ...
        //Get All Companies
        //GET /api/companies
        endpoint.MapGet("", async (ICompanyServices companyService) =>
        {
        ...
        endpoint.MapPost("", async (IValidator<UpsertCompany> validator,
            ...
            ICompanyServices companyService, UpsertCompany data) =>
        {
            var response = new ApiResponse();
            ...
            try
            {
                ...
                var newCompany = await companyService.AddCompanyAsync(data);
        ...
        endpoint.MapGet("{id:int}", async (int id, ICompanyServices companyService) =>
        {
            var response = new ApiResponse();
            ...
            ICompanyServices companyService, UpsertCompany data) =>
        {
            ...
            try
            {
                ...
                var updatedCompany = await companyService.UpdateCompanyAsync(id, data);
        ...
        endpoint.MapDelete("{id:int}", async (int id, ICompanyServices companyService) =>
        {
            var response = new ApiResponse();

            try
            {
                var affRows = await companyService.DeleteCompanyAsync(id);
